...
class UpdateListing extends StatelessWidget {

  UpdateListing({Key? key}) : super(key : key);
  ...
  Widget build(BuildContext context) {
    ...
    final listing = Provider.of<ListingRepository>(context,listen: false).readDataById(id);
    _titleController.text = listing.title!;
    _costController.text = listing.cost.toString();
    _descriptionController.text = listing.description!;
    _sellerController.text = listing.seller!;
                        ...
                        Expanded(
                          child: TextFormField(
                            ...
                            validator: (value) {
                              ...
                              if (int.tryParse(value) == null) return "The cost is numeric";
                              return null;
                            },
                            decoration: InputDecoration(
                              labelText: 'Cost',
                    ...
                    child: ElevatedButton.icon(
                      ...
                      onPressed: () async {
                        if (_formKey.currentState!.validate()) {
                          loading.value = true;
                          Listing updatedListing = listing.copyWith(
                          ...
                          try {
                            Provider.of<ListingRepository>(
                                context, listen: false).updateData(updatedListing);
                          }catch(error){
                            final logger = Logger();
                            logger.e('Exception: $error');
                            _showSnackBar(context, 'Error updating listing: $error');
                          }
